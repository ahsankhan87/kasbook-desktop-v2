...
namespace pos.Customers.Customer_Ledger_Report {
    ...
    public class CustomerPayment : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "pos.Customers.Customer Ledger Report.CustomerPayment.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCustomerPayment : Component, ICachedReport {
        
        public CachedCustomerPayment() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CustomerPayment rpt = new CustomerPayment();
            rpt.Site = this.Site;
            return rpt;
        }
