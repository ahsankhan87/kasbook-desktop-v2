...
{
    public class frm_SalesByCustomerReport : BaseReportForm
    {
        public frm_SalesByCustomerReport()
        {
        ...
        protected override DataTable GetData(DateTime from, DateTime to, int? branchId)
        {
            ...
            var dt = bll.CusomerWiseSaleReport(f, t, customer_id, product_code, sale_type, employee_id, sale_account, branch_id);
            return dt;
        }
    }
}
