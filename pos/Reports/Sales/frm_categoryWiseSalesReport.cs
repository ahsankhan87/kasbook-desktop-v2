...
namespace pos
{
    public partial class frm_categoryWiseSalesReport : Form
    {
        ...
        public frm_categoryWiseSalesReport()
        {
            InitializeComponent();
        ...
        private void categoryWiseSalesReport_Load(object sender, EventArgs e)
        {
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                accounts_dt = sale_report_obj.categoryWiseSaleReport(from_date, to_date, customer_id, product_code, sale_type, employee_id, sale_account, branch_id);
               ...
               // double _vat_total = 0;
                ...
                {
                    _quantity_sold_total += Convert.ToDouble(dr["qty"].ToString());
                   ...
                   // _vat_total += Convert.ToDouble(dr["vat"].ToString());
                    _total += Convert.ToDouble(dr["total_amount"].ToString());
                }

                DataRow newRow = accounts_dt.NewRow();
                newRow[2] = "Total";
                newRow[1] = _quantity_sold_total;
        ...
        private void frm_categoryWiseSalesReport_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
