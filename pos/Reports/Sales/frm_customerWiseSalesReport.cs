...
namespace pos
{
    public partial class frm_customerWiseSalesReport : Form
    {
        ...
        public frm_customerWiseSalesReport()
        {
            InitializeComponent();
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                accounts_dt = sale_report_obj.CusomerWiseSaleReport(from_date, to_date, customer_id, product_code, sale_type, employee_id, sale_account, branch_id);
        ...
        private void frm_customerWiseSalesReport_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "Customer Wise Sale Report";
