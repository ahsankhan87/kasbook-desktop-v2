...
{
    public partial class frm_AllBankReport : Form
    {
        public frm_AllBankReport()
        {
            InitializeComponent();
        }
        ...
        private void frm_AllBankReport_Load(object sender, EventArgs e)
        {
        ...
        public void LoadReport(string fromDate, string toDate, bool _isPrint)
        {
            ...
            reportDoc.Load(appPath + @"\\reports\\Accounts\\Banks\\BanksReport.rpt");
        ...
        private void frm_AllBankReport_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
