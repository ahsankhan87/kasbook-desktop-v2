    ...
    public partial class frm_accounting_settings : Form
    {
        ...
        private void LoadVoucherGrid()
        {
            if (gridVoucher.Rows.Count == 0)
            {
                ...
                gridVoucher.Rows.Add("SALE", _settings.GetString("ACC_VOUCHER_SALE_PREFIX", "S"), branchId.ToString(), _settings.GetString("ACC_VOUCHER_SALE_FORMAT", "YYYY-NNNN"), _settings.GetString("ACC_VOUCHER_SALE_RESET", "Annually"), _settings.GetString("ACC_VOUCHER_SALE_START", "1"), "");
                gridVoucher.Rows.Add("SALES_RETURN", _settings.GetString("ACC_VOUCHER_SALES_RETURN_PREFIX", "SR"), branchId.ToString(), _settings.GetString("ACC_VOUCHER_SALES_RETURN_FORMAT", "YYYY-NNNN"), _settings.GetString("ACC_VOUCHER_SALES_RETURN_RESET", "Annually"), _settings.GetString("ACC_VOUCHER_SALES_RETURN_START", "1"), "");
                gridVoucher.Rows.Add("ESTIMATE", _settings.GetString("ACC_VOUCHER_ESTIMATE_PREFIX", "E"), branchId.ToString(), _settings.GetString("ACC_VOUCHER_ESTIMATE_FORMAT", "YYYY-NNNN"), _settings.GetString("ACC_VOUCHER_ESTIMATE_RESET", "Annually"), _settings.GetString("ACC_VOUCHER_ESTIMATE_START", "1"), ""); 
                gridVoucher.Rows.Add("PURCHASE", _settings.GetString("ACC_VOUCHER_PURCHASE_PREFIX", "P"), branchId.ToString(), _settings.GetString("ACC_VOUCHER_PURCHASE_FORMAT", "YYYY-NNNN"), _settings.GetString("ACC_VOUCHER_PURCHASE_RESET", "Annually"), _settings.GetString("ACC_VOUCHER_PURCHASE_START", "1"), "");
                gridVoucher.Rows.Add("PURCHASE_RETURN", _settings.GetString("ACC_VOUCHER_PURCHASE_RETURN_PREFIX", "PR"), branchId.ToString(), _settings.GetString("ACC_VOUCHER_PURCHASE_RETURN_FORMAT", "YYYY-NNNN"), _settings.GetString("ACC_VOUCHER_PURCHASE_RETURN_RESET", "Annually"), _settings.GetString("ACC_VOUCHER_PURCHASE_RETURN_START", "1"), "");
                gridVoucher.Rows.Add("PURCHASE_ORDER", _settings.GetString("ACC_VOUCHER_PURCHASE_ORDER_PREFIX", "PO"), branchId.ToString(), _settings.GetString("ACC_VOUCHER_PURCHASE_ORDER_FORMAT", "YYYY-NNNN"), _settings.GetString("ACC_VOUCHER_PURCHASE_ORDER_RESET", "Annually"), _settings.GetString("ACC_VOUCHER_PURCHASE_ORDER_START", "1"), "");
            }
