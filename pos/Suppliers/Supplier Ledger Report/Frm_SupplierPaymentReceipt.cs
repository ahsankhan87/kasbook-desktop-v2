...
{
    public partial class Frm_SupplierPaymentReceipt : Form
    {
        string _payment_id;

        public Frm_SupplierPaymentReceipt(string payment_id)
        {
            _payment_id = payment_id;
            InitializeComponent();
        }

        private void Frm_SupplierPaymentReceipt_Load(object sender, EventArgs e)
        {
        ...
        public void LoadReport(string payment_id, bool _isPrint)
        {
            ...
            reportDoc.Load(appPath + @"\\reports\\Accounts\\\Customers\\SupplierPaymentReceipt.rpt");
