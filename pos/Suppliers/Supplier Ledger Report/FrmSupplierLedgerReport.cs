...
{
    public partial class FrmSupplierLedgerReport : Form
    {
        string _supplier_id;
        public FrmSupplierLedgerReport(string supplier_id)
        {
            _supplier_id = supplier_id;
            InitializeComponent();
        }
        public FrmSupplierLedgerReport()
        {
            InitializeComponent();
        }
        ...
        private void FrmSupplierLedgerReport_Load(object sender, EventArgs e)
        {
        ...
        public void LoadReport(string supplier_id, string fromDate, string toDate, bool _isPrint)
        {
            // Create an instance of your report
            string appPath = Path.GetDirectoryName(Application.ExecutablePath);
            ReportDocument reportDoc = new ReportDocument();
            reportDoc.Load(appPath + @"\\reports\\Accounts\\\Customers\\SupplierLedger.rpt");
            ...
            reportDoc.SetParameterValue("supplier_id", supplier_id);
        ...
        {
            LoadReport(_supplier_id, txt_from_date.Value.ToShortDateString(), txt_to_date.Value.ToShortDateString(), false);
        }

        private void FrmSupplierLedgerReport_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
