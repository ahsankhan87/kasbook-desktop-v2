...
{
    public class Customer1SelectedEventArgs : EventArgs
    {
        public int CustomerId { get; }
        public string Name { get; }
        public string Phone { get; }
        public string VatNo { get; }
        public Customer1SelectedEventArgs(int id, string name, string phone, string vat)
        {
    ...
    public sealed class CustomerGridDropDownCopy : IDisposable
    {
        ...
        public CustomerGridDropDownCopy()
        {
