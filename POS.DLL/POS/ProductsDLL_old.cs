...
namespace POS.DLL
{
    public class ProductDLL_old
    {
        private SqlCommand cmd;
        private SqlDataAdapter da;
        private DataTable dt = new DataTable();
        private ProductModal info = new ProductModal();
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    if (cn.State == ConnectionState.Closed)
                    {
                        ...
                        cmd = new SqlCommand("sp_ProductsCrud", cn);
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    if (cn.State == ConnectionState.Closed)
                    {
                        ...
                        cmd = new SqlCommand("SELECT code, name FROM pos_products WHERE deleted != '1'", cn);
                        //cmd.Parameters.AddWithValue("@branch_id", UsersModal.logged_in_branch_id);
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    if (cn.State == ConnectionState.Closed)
                    {
                        ...
                        cmd = new SqlCommand("SELECT code FROM pos_products WHERE item_number = @item_number AND category_code=@category_code", cn);
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    if (cn.State == ConnectionState.Closed)
                    {
                        ...
                        cmd = new SqlCommand("SELECT barcode FROM pos_products WHERE barcode = @barcode", cn);
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    if (cn.State == ConnectionState.Closed)
                    {
                        ...
                        cmd = new SqlCommand("SELECT name FROM pos_products WHERE deleted != '1'", cn);
                        //cmd.Parameters.AddWithValue("@branch_id", UsersModal.logged_in_branch_id);
        ...
        public DataTable SearchRecordByProductCode_1(string product_code)
        {
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    ...
                    {
                        cn.Open();
                        string query = "SELECT P.id,P.name,P.cost_price,P.unit_price,P.item_type,P.code,P.tax_id,P.category_code," +
                            " COALESCE((select  TOP 1 COALESCE(s.qty,0) as qty from pos_product_stocks s where s.item_code=P.code and s.branch_id=@branch_id),0) as qty," + //branch wise qty
        ...
        public DataTable SearchRecordByProductID(string product_id)
        {
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    ...
                    {
                        cn.Open();
                        string query = "SELECT P.id,P.code,P.name,P.name_ar,P.brand_code,P.item_type,P.barcode,P.avg_cost,P.tax_id,P.location_code," +
        ...
        public DataTable SearchRecordByProductName(string product_name)
        {
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    ...
                    {
                        cn.Open();
                        string query = "SELECT P.id,P.name, P.cost_price,P.unit_price,P.item_type,P.code,P.tax_id,,P.location_code," +
                             " COALESCE((select  TOP 1 COALESCE(s.qty,0) as qty from pos_product_stocks s where s.item_code=P.code and s.branch_id=@branch_id),0) as qty," + //branch wise qty
                            " T.title AS tax_title,T.rate AS tax_rate" +
                            " FROM pos_products P" +
                            " LEFT JOIN pos_taxes T ON T.id=P.tax_id" +
        ...
        public DataTable Get_otherStock(string Product_code)
        {
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    ...
                    if (cn.State == ConnectionState.Closed)
                    {
                        ...
                        cmd = new SqlCommand();
                        string query = "SELECT S.qty, B.name AS branch_name FROM pos_product_stocks S" +
                            " LEFT JOIN pos_branches B ON S.branch_id=B.id"+
                            " WHERE S.item_code = @code AND S.branch_id <> @branch_id";
                        // "AND P.branch_id = @branch_id";
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    if (cn.State == ConnectionState.Closed)
                    {
                        ...
                        cmd = new SqlCommand("SELECT MAX(invoice_no) FROM pos_product_adjustment", cn);
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    if (cn.State == ConnectionState.Closed)
                    {
                        ...
                        cmd = new SqlCommand("SELECT MAX(invoice_no) FROM pos_product_loc_transfer", cn);
