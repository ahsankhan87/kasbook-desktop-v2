...
namespace POS.DLL
{
    public class PaymentMethodDLL
    {
        private SqlCommand cmd;
        private SqlDataAdapter da;
        private DataTable dt = new DataTable();
        private PaymentMethodModal info = new PaymentMethodModal();
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    if (cn.State == ConnectionState.Closed)
                    {
                        ...
                        cmd = new SqlCommand("sp_payment_methodCrud", cn);
        ...
        public int Insert(PaymentMethodModal obj)
        {
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    ...
                    Log.LogAction("Add Payment Method", $"Payment Method Code: {obj.code}, Payment Method Name: {obj.description}", UsersModal.logged_in_userid, UsersModal.logged_in_branch_id);
        ...
        public int Update(PaymentMethodModal obj)
        {
            ...
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    ...
                    result = Convert.ToInt32(cmd.ExecuteScalar());
                    Log.LogAction("Update Payment Method", $"Payment Method Code: {obj.code}, Payment Method Name: {obj.description}", UsersModal.logged_in_userid, UsersModal.logged_in_branch_id);
        ...
        public int Delete(int PaymentMethodId)
        {
            using (SqlConnection cn = new SqlConnection(dbConnection.ConnectionString))
            {
                try
                {
                    ...
                    Log.LogAction("Delete Payment Method", $"Payment Method ID: {PaymentMethodId}", UsersModal.logged_in_userid, UsersModal.logged_in_branch_id);
