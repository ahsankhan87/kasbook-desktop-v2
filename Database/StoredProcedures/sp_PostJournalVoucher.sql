IF OBJECT_ID(N'dbo.sp_PostJournalVoucher', N'P') IS NOT NULL
	DROP PROCEDURE dbo.sp_PostJournalVoucher;
GO

CREATE PROCEDURE dbo.sp_PostJournalVoucher
	@VoucherXml XML
AS
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN TRY
		...
		(
			...
			user_id, branch_id, period_id, date_created, customer_id, supplier_id, bank_id,
...
/*
XML payload expected by sp_PostJournalVoucher:
<Voucher>
  <Header>
	<VoucherId>0</VoucherId>
	<VoucherNo>JV-2026-0001</VoucherNo>
	<VoucherDate>2026-07-08</VoucherDate>
	<VoucherType>Journal</VoucherType>
	<ReferenceNo>REF-001</ReferenceNo>
	<Narration>Sample voucher</Narration>
	<Attachment />
	...
	<ReversalOf />
	<PostedBy>1</PostedBy>
	<PostedAt>2026-07-08T10:00:00.0000000Z</PostedAt>
	<IsAutoPosted>0</IsAutoPosted>
	<RefModule />
	<RefId />
	<BranchId>1</BranchId>
	<CompanyId>1</CompanyId>
	<CreatedBy>1</CreatedBy>
	<CreatedAt>2026-07-08T10:00:00.0000000Z</CreatedAt>
  </Header>
  <Lines>
	<Line>
	  <LineNo>1</LineNo>
