...
- Do not use legacy company-table fallback for account resolution in inventory adjustment; use accounting settings only because the legacy path will be removed.
